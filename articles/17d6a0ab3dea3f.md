...
**ユーザーストーリー**は、ユースケースをより具体的に表現する手法です。**「誰として、何をしたい、なぜなら〜だから」**という形式で、利用者の視点から機能要件を記述します。

**ユーザーストーリーの利点：**
- **受入基準**が明確になり、開発完了の判定がしやすい
- **優先順位**をつけやすく、アジャイル開発に適している
- **ビジネス価値**が分かりやすく、ステークホルダーとの合意形成が容易

**ユースケースとの使い分け：**
- **ユースケース**: システム全体の機能概要を把握
- **ユーザーストーリー**: 個別機能の詳細仕様を定義
