...
ChatGPTの登場により毎日AI領域で世界が変わっているのを、エンジニアのみなさんは肌で感じているのではないでしょうか？これからAIはどうなっていくのか、というワクワクとする期待感とともに若干の恐怖も感じているのではないでしょうか？この記事ではまだあんまり追いついてないという方向けにChatGPT関連のリンクのカテゴリー別の雑なまとめとなっています。それぞれ興味のあるところから読んでいただくなり、試していただくなりして、キャッチアップしていきましょう！
以下カテゴリーとなります。
- まずは公式ドキュメント読みたい方
- まずはこの記事を
- ブレストや要件定義で使用したい
...
GPT-4の力を最大限引き出す：プロンプトエンジニアリング基礎編｜ChatGPT 研究所 https://chatgpt-lab.com/n/n67b5c987a74c


### ChatGPTでやってみた

ChatGPTによるデータ変換がもたらすインパクト - Speaker Deck https://speakerdeck.com/masahiro_nishimi/chatgptniyorudetabian-huan-gamotarasuinpakuto

LayerXにおける ChatGPTを活用したPoC事例 / layerx-poc-with-chatgpt - Speaker Deck https://speakerdeck.com/yuya4/layerx-poc-with-chatgpt

ChatGPT選手権! LT大会 @Findy - Speaker Deck https://speakerdeck.com/sasanoshouta/chatgptxuan-shou-quan-ltda-hui-at-findy

ChatGPTをプロダクトに入れる開発が"毎日がAfter GPT"だった件/ChatGPT LT Link and Motivation - Speaker Deck https://speakerdeck.com/lmi/chatgpt-lt-link-and-motivation

スマートラウンドで試してみた ChatGPT活用成功/失敗事例8選！ - Speaker Deck https://speakerdeck.com/doyaaaaaken/shi-bai-shi-li-8xuan

一緒にスクラム開発: GPT-4と人間が共創するプロダクトの進化 スプリント #1 https://zenn.dev/itohiro73/articles/8bc4330b7c7de7
...
GPTが自社の情報を正しく学習するためにはWebサイトをセマンティックなHTMLでマークアップした方がよい説 | DevelopersIO https://dev.classmethod.jp/articles/improving-website-markup-for-effective-gpt-learning/
...
NOT A HOTEL AIコンシェルジュ「Kevin」の開発秘話 - Speaker Deck https://speakerdeck.com/codehex/not-a-hotel-aikonsieruziyu-kevin-nokai-fa-mi-hua

ChatGPT選手権！エンジニアリングに組み込んでみたらこうなりました LT大会 - connpass https://findy.connpass.com/event/276736/
...
4/11（火）クラウド、ChatGPTなど最新技術を学ぶ「DevelopersIO Day One」 - connpass https://classmethod.connpass.com/event/276869/
