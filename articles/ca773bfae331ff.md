...
* Devは開発のアジリティを上げ、生産性G/P(Gross/Productivity)を上げることでプロダクトの価値へつなげます。
...
### 今後の展望
開発体制とアーキテクチャの刷新により、生産性を上げる仕組みは整いました。今後の展望はG/Pをさらに倍増させる仕組み作り、仮説・検証を繰り返すことでプロダクト価値を高め、サービスの成長曲線を描いていきます。
